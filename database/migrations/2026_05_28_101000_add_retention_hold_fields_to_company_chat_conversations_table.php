...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('company_chat_conversations', function (Blueprint $table): void {
            $table->boolean('retention_hold')->default(false)->index()->after('last_message_excerpt');
            ...
            $table->foreignId('retention_hold_created_by')->nullable()->constrained('users')->nullOnDelete()->after('retention_hold_created_at');
            $table->timestamp('retention_hold_expires_at')->nullable()->index()->after('retention_hold_created_by');
        });
    }
