...
class AdminChatGroupLogController extends Controller
{
    ...
    public function export(Request $request): StreamedResponse
    {
        ...
        if (! Schema::hasTable('company_chat_group_activity_logs')) {
            return response()->streamDownload(function (): void {
                ...
                fclose($output);
            }, 'logs-grupos-chat-pendiente-migracion.csv', [
        ...
        $filename = $action
            ? "logs-grupos-chat-{$action}-{$timestamp}.csv"
            : "logs-grupos-chat-{$timestamp}.csv";
    ...
    {
        $allowedActions = [
            CompanyChatGroupActivityLog::ACTION_CREATED,
            CompanyChatGroupActivityLog::ACTION_UPDATED,
            CompanyChatGroupActivityLog::ACTION_DELETED,
        ];
    ...
    {
        return CompanyChatGroupActivityLog::query()
