                ...
                <div class="grid gap-6 md:grid-cols-2">
                    <div>
                        ...
                        @if ($isManager)
                            ...
                            <p class="mt-2 text-xs text-brand-secondary/60">Como gestor, no puedes modificar el rol.</p>
                        @else
                            <div class="relative">
                    ...
                    <div id="dealership-wrapper" @class(['hidden' => ! $showDealershipField])>
                    ...
                    <div id="salesforce-user-id-wrapper" @class(['hidden' => ! $showSalesforceField])>
                        ...
                        <input id="salesforce_user_id" name="salesforce_user_id" type="text" value="{{ old('salesforce_user_id', $user->salesforce_user_id) }}" @required($showSalesforceField)
                            class="w-full rounded-2xl border border-gray-300 px-4 py-3 text-sm text-brand-secondary outline-none transition focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20">
                        <p class="mt-2 pl-2 text-xs text-brand-secondary/60">Si el usuario deja de ser comercial, este campo se limpiará automáticamente.</p>
                    </div>
                </div>
