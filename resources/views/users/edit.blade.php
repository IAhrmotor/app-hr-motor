                            ...
                            @foreach ($itScheduleDays as $dayKey => $dayLabel)
                                <div class="grid gap-4 md:grid-cols-[160px_minmax(0,1fr)_minmax(0,1fr)] md:items-end">
                                    ...
                                    <div>
                                        ...
                                        <input id="it_{{ $dayKey }}_start" name="it_{{ $dayKey }}_start" type="time" step="60" value="{{ old('it_' . $dayKey . '_start', $user->{'it_' . $dayKey . '_start'}) }}" data-it-schedule-input @required($showItScheduleFields)
                                            class="w-full rounded-2xl border border-gray-300 px-4 py-3 text-sm text-brand-secondary outline-none transition focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input id="it_{{ $dayKey }}_end" name="it_{{ $dayKey }}_end" type="time" step="60" value="{{ old('it_' . $dayKey . '_end', $user->{'it_' . $dayKey . '_end'}) }}" data-it-schedule-input @required($showItScheduleFields)
                                            class="w-full rounded-2xl border border-gray-300 px-4 py-3 text-sm text-brand-secondary outline-none transition focus:border-brand-primary focus:ring-2 focus:ring-brand-primary/20">
                                    </div>
                                </div>
                            @endforeach
