            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-3 xl:flex-row xl:items-stretch xl:justify-between">
                    ...
                    <div class="grid gap-3 xl:min-w-[12rem] xl:grid-cols-1">
                        ...
                        <a href="{{ route('admin.dealership-logs.index') }}" data-logs-reset
            ...
            <table class="min-w-full divide-y divide-brand-secondary/10">
                <thead class="bg-slate-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-[0.16em] text-brand-secondary/60">Delegacion afectada</th>
                    ...
                    @forelse ($logs as $log)
                        <tr class="align-top">
                            ...
                            <td class="px-6 py-5 text-sm text-brand-secondary">
                                ...
                                <p class="mt-1 text-brand-secondary/65">{{ $log->target_salesforce_id ?: 'Sin ID Salesforce' }}</p>
                                <p class="mt-1 text-brand-secondary/65">{{ $log->target_phone ?: 'Sin telefono' }}</p>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-10 text-center text-sm text-brand-secondary/65">
                                Todavia no hay logs de delegaciones para los filtros seleccionados.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
