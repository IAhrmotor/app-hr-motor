...
@section('content')
    <main class="mx-auto max-w-7xl px-6 py-10 lg:px-8">
        ...
        <div id="admin-chat-group-logs-container">
            @include('admin.chat-group-logs.partials.content')
        </div>
    </main>

    <script>
        window.initAdminChatGroupLogsFilters = function () {
            const root = document.getElementById('admin-chat-group-logs-view');
            ...
            const replaceView = (html, nextUrl) => {
                const container = document.getElementById('admin-chat-group-logs-container');
                ...
                window.initAdminChatGroupLogsFilters();
            };
            ...
            form.addEventListener('submit', async (event) => {
                ...
                try {
                    ...
                    await fetchAndReplace(targetUrl);
                } finally {
                    submitButton.classList.remove('opacity-80', 'pointer-events-none');

                    if (label && previousLabel !== undefined) {
