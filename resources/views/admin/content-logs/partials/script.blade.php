<script>
    window.initAdminLogsFilters = function () {
        ...
        const contentTypeDisplay = form.querySelector('[data-display-content-type]');
        ...
        syncDateBounds();
        updateSelectDisplay(contentTypeSelect, contentTypeDisplay, 'Todo el contenido');
        ...
        [contentTypeSelect, actionSelect, actorSelect].forEach((select) => {
