    ...
    <div class="flex flex-col gap-4">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div class="max-w-3xl">
                ...
                <h1 class="mt-3 text-3xl font-semibold text-brand-secondary md:text-4xl">Logs de tags</h1>
                <p class="mt-3 text-sm leading-6 text-brand-secondary/70 md:text-base">
                    Aqui puedes revisar las altas, ediciones y eliminaciones de tags con su fecha, hora y la persona que realizo la gestion.
                </p>
            </div>

            <a href="{{ route('admin.forum-tag-logs.export', request()->only(['action', 'date_from', 'date_to', 'actor'])) }}"
        ...
        <form method="GET" action="{{ route('admin.forum-tag-logs.index') }}" data-logs-filter-form
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-3 xl:flex-row xl:items-stretch xl:justify-between">
                    ...
                    <div class="grid gap-3 xl:min-w-[12rem] xl:grid-cols-1">
                        ...
                        <a href="{{ route('admin.forum-tag-logs.index') }}" data-logs-reset
            ...
            <table class="min-w-full divide-y divide-brand-secondary/10">
                <thead class="bg-slate-50">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-xs font-semibold uppercase tracking-[0.16em] text-brand-secondary/60">Tag afectado</th>
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="px-6 py-10 text-center text-sm text-brand-secondary/65">
                                Todavia no hay logs de tags para los filtros seleccionados.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
