...
<section id="admin-logs-view" class="rounded-[2rem] border border-brand-secondary/10 bg-white p-6 shadow-sm md:p-8">
    <div class="flex flex-col gap-4">
        ...
        <form method="GET" action="{{ route('admin.logs.index') }}" data-logs-filter-form
            ...
            <div class="flex flex-col gap-4">
                <div class="flex flex-col gap-3 xl:flex-row xl:items-stretch xl:justify-between">
                    ...
                    <div class="grid gap-3 xl:min-w-[12rem] xl:grid-cols-1">
                        ...
                        <a href="{{ route('admin.logs.index') }}" data-logs-reset
                    ...
                    @forelse ($logs as $log)
                        <tr class="align-top">
                            ...
                            <td class="px-6 py-5 text-sm text-brand-secondary">
                                ...
                                <p class="mt-1 text-brand-secondary/65">{{ $log->target_email }}</p>
                                <p class="mt-1 text-brand-secondary/65">
                                    {{ $log->target_role ?? 'Sin rol' }}
                                    @if ($log->target_dealership)
