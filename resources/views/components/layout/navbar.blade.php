                ...
                <div class="relative" @click.outside="notificationsOpen = false" data-notification-summary-url="{{ route('notifications.summary') }}">
                    <button type="button" @click="notificationsOpen = !notificationsOpen; profileOpen = false"
                        ...
                        @if ($forumUnreadNotificationCount > 0)
                            <span
                                class="absolute -right-1 -top-1 inline-flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-center text-[11px] font-semibold leading-none tabular-nums text-white shadow-sm ring-2 ring-white"
                                data-notification-badge>
                                {{ $forumUnreadNotificationCount > 9 ? '+9' : $forumUnreadNotificationCount }}
                            </span>
                        @else
                            <span
                                class="absolute -right-1 -top-1 hidden h-5 w-5 items-center justify-center rounded-full bg-red-500 text-center text-[11px] font-semibold leading-none tabular-nums text-white shadow-sm ring-2 ring-white"
