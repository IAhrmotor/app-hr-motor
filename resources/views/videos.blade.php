                ...
                <div class="max-w-3xl">
                    ...
                    <div class="mt-5 max-w-xl">
                        ...
                        <div class="relative">
                            ...
                            <input id="video-search" x-model="search" type="text" placeholder="Buscar por título..."
                                class="w-full rounded-2xl border border-white/15 bg-white/10 py-3 pl-4 pr-4 text-sm text-white placeholder:text-white/65 backdrop-blur-md outline-none transition focus:border-white/30 focus:bg-white/15">
                        </div>
                        ...
                        <template x-for="video in filteredVideos" :key="video.youtube_id">
                            <article
                                ...
                                <div class="border-t border-brand-secondary/10 px-4 py-4">
                                    <h2 class="text-center text-sm font-semibold text-brand-secondary md:text-base"
